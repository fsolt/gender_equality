...
@Soss2007 [, 121] contends that public responsiveness should be expected when policies are both salient (as opposed to obscure) and a direct and tangible presence in people's lives (as opposed to distant in geographic, social, or temporal terms).
Salient policies are highly visible and attract attention.
Women in office and policies advancing gender equality are the opposite of obscure: they attract attention by challenging the masculine status quo of the public sphere in very visible ways that provoke a response [see @Weeks2022].
...
In a world in which the public sphere is traditionally dominated by men, policies advancing gender equality in politics and employment are undoubtedly tangible as well.
In the absence of the pervasive notion of public opinion backlash, there would be little reason to doubt that movement with regard to gender equality in politics and policy would generate accelerating, not self-undermining, feedback.
...
As a practical matter, then, the findings reported here suggest that there is no reason to think that public opinion will ever consistently backlash against gender equality.

Note that _consistently_ is doing some work in that last sentence.
