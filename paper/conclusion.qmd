...
Changes in both descriptive representation (see @fig-m1-dr) and these policies (see @fig-m1-wbl) are predicted by changes in public opinion toward women
...
Evidence that public opinion, considered as support for democracy in the abstract, leads to democratic deepening or prevents democratic backsliding has been scant.
