...
amb_regions2 <- tibble(var_state = 1:32,
...
```{r poststrat_all}
poststrat_all <- read_feather(file.path(mex20_dir, "..", "poststrat_all.arrow"))
```
...
m1 <- brm(target | thres(thres, gr = item) ~ Intercept +
            ...
            (1|stratum:region) + (1|stratum:state) +
