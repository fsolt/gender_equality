...
Subnational comparative: @Snyder2001; @Zuo2015
...
circunscripciones <- tibble(state = c("Aguascalientes", "Baja California", 
                                     ...
                                     "Distrito Federal"),
                        circunscripcion = structure(c(2L, 1L, 1L, 3L, 
                                             3L, 1L, 4L, 2L, 5L, 1L, 2L, 4L, 5L,
                                             1L, 5L, 4L, 5L, 1L, 2L, 3L, 
                                             4L, 2L, 3L, 2L, 1L, 1L, 3L, 2L, 4L,
                                           3L, 3L, 2L, 4L), 
                                         levels = c("I",
                                                    "II",
                                                    "III", 
...
amb_regions <- tibble(var_state = c(1:32, 10000),
                      state = c("Aguascalientes", "Baja California", 
                                "Baja California Sur", "Campeche", "Chiapas",
                                ...
                                "Yucatán", "Zacatecas", "National"),
                      region = c(2L, 1L, 1L, 4L, 
                                 4L, 1L, 1L, 2L, 3L, 1L, 2L, 4L, 3L,
                                 2L, 2L, 3L, 3L, 2L, 1L, 4L, 
                                 3L, 3L, 4L, 1L, 1L, 1L, 4L, 1L, 3L,
                                 4L, 4L, 1L, 100L),
                      region3 = c(2L, 1L, 1L, 3L, 
                                 3L, 1L, 1L, 2L, 3L, 1L, 2L, 3L, 2L,
                                 2L, 2L, 2L, 2L, 2L, 1L, 3L, 
                                 2L, 2L, 3L, 1L, 1L, 1L, 3L, 1L, 2L,
                                 3L, 3L, 1L, 100L),
                      circunscripcion = c(2L, 1L, 1L, 3L, 3L, 1L,
                                          2L, 5L, 4L, 1L, 2L, 4L,
                                          5L, 1L, 5L, 4L, 5L, 1L,
                                          2L, 3L, 4L, 2L, 3L, 2L,
                                          1L, 1L, 3L, 2L, 4L, 3L,
                                          3L, 2L, 100L)) %>% # region and circunscripcion
  bind_rows(tibble(var_state = c(2003006001000250026,
                                 140018, 70019002400280032,
                                 10011,
                                 400500200023002700300031, 9001600210029,
                                 80015, 130017),
                   state = c("Baja California, Baja California Sur, Chihuahua, Durango, Sinaloa, Sonora",
                             "Jalisco, Nayarit", "Coahuila, Nuevo León, San Luis Potosí, Tamaulipas, Zacatecas", 
                             "Aguascalientes, Guanajuato",
                             "Campeche, Chiapas, Oaxaca, Quintana Roo, Tabasco, Veracruz, Yucatán", "Distrito Federal, Puebla, Tlaxcala",
                             "Colima, Michoacán", "Hidalgo, México"),
                   region = c(1L, 
                              2L, 1L,
                              2L,
                              4L, 3L,
                   ...
                   region3 = c(1L, 
                               ...
                               3L, 2L,
                               2L, 2L),
                   circunscripcion = c(1L, 1L, 2L, 2L, 3L, 4L, 5L, 5L))) %>% # circunscripcion only
  bind_rows(tibble(circunscripcion = c(1L, 2L, 3L, 4L, 5L),
                   state = c("Baja California, Baja California Sur, Chihuahua, Durango, Jalisco, Nayarit, Sinaloa, Sonora",
                             "Aguascalientes, Coahuila, Guanajuato, Nuevo León, Queretaro, San Luis Potosi, Tamaulipas, Zacatecas", 
                             "Campeche, Chiapas, Oaxaca, Quintana Roo, Tabasco, Veracruz, Yucatán", 
                             "Distrito Federal, Guerrero, Morelos, Puebla, Tlaxcala", 
                             "Colima, Hidalgo, Michoacan, Mexico"),
                   region = c(5L, 5L, 4L, 6L, 7L),
                   region3 = c(6L, 7L, 3L, 2L, 2L),
                   var_state = c(200300600100014001800250026,
                                 1007001100190022002400280032,
                                 400500200023002700300031, 
                                 9001200160021002900,
                                 8001300150017))) %>% 
  bind_rows( # region only
    full_join(tibble(region = c(1L, 2L, 3L, 4L, 5L),
                   state = c("Baja California, Baja California Sur, Chihuahua, Coahuila, Durango, Nuevo León, San Luis Potosí, Sinaloa, Sonora, Tamaulipas, Zacatecas",
                             "Aguascalientes, Colima, Guanajuato, Jalisco, Michoacán, Nayarit", 
                             "Distrito Federal, Hidalgo, Morelos, México, Puebla, Querétaro, Tlaxcala", 
                             "Campeche, Chiapas, Guerrero, Oaxaca, Quintana Roo, Tabasco, Veracruz, Yucatán",
                             "Aguascalientes, Colima, Guanajuato, Jalisco, Michoacán, Nayarit, Distrito Federal, Hidalgo, Morelos, México, Puebla, Querétaro, Tlaxcala"), 
                   circunscripcion = c(6, 7, 8, 9, 10),
                   var_state = c(20030060070010001900240025002600280032,
                                 10080011001400150018, 
                                 9001300160017002100220029,
                                 4005001200200023002700300031,
              10080011001400150018009001300160017002100220029)),
              # region3 only
  tibble(region3 = c(1L, 3L, 2L, 4L, 5L),
                   state = c("Baja California, Baja California Sur, Chihuahua, Coahuila, Durango, Nuevo León, San Luis Potosí, Sinaloa, Sonora, Tamaulipas, Zacatecas",
                             "Campeche, Chiapas, Guerrero, Oaxaca, Quintana Roo, Tabasco, Veracruz, Yucatán",
                             "Aguascalientes, Colima, Guanajuato, Jalisco, Michoacán, Nayarit, Distrito Federal, Hidalgo, Morelos, México, Puebla, Querétaro, Tlaxcala",
                             "Aguascalientes, Colima, Guanajuato, Jalisco, Michoacán, Nayarit", 
                             "Distrito Federal, Hidalgo, Morelos, México, Puebla, Querétaro, Tlaxcala"), 
                   circunscripcion = c(6, 9, 10, 7, 8),
                   var_state = c(20030060070010001900240025002600280032,
                                 4005001200200023002700300031,                             10080011001400150018009001300160017002100220029,
                                 10080011001400150018, 
                                 9001300160017002100220029)),
  by = join_by(state, circunscripcion, var_state))) %>% 
  distinct()
```
...
censo1990 <- censo1990_raw %>%
  ...
  transmute(muni_size = case_when(POBTOT > 100000 ~
                                    "Grande (más de 100,000)",
                                  between(POBTOT, 25000, 100000) ~
            ...
            region,
            year = 1990,
            rural = if_else(as.numeric(TAM_LOC) == 1, "rural", "urban") %>% 
            ...
            agegrp = cut(as.numeric(ANO_CUMP), 
                         ...
                         labels = c("18 to 24", "25 to 44",
                                    "45 to 64", "65+")),
            years_edu = ANO_APRO,
            educ = case_when(((NIV_EST == "0" | NIV_EST == "1") &
                                years_edu < 6) ~ 1, # less than primary
...
censo2010 <- censo2010_raw %>%
  ...
  filter(as.numeric(EDAD) >= 18) %>% 
  left_join(iter2010, by = join_by(ENT, MUN)) %>% 
  transmute(muni_size = case_when(POBTOT > 100000 ~ "Grande (más de 100,000)",
                                  between(POBTOT, 25000, 100000) ~ "Mediana (entre 25,000 y 100,000)",
                                  POBTOT < 25000 ~ "Pequeña (menos de 25,000)") %>% 
              factor(levels = c("Grande (más de 100,000)",
            ...
            agegrp = cut(as.numeric(EDAD), 
                         breaks = c(17, 24, 44, 64, 150),
                         labels = c("18 to 24", "25 to 44", "45 to 64", "65+")),
            educ = case_when(NIVACAD == "00" | NIVACAD == "01" ~ 1,
...
censo2020 <- censo2020_raw %>%
  ...
  transmute(muni_size = case_when(POBTOT > 100000 ~ "Grande (más de 100,000)",
            ...
            region,
            year = 2020,
            rural = if_else(TAMLOC == 1, "rural", "urban") %>% 
              factor(levels = c("urban", "rural")),
            stratum = as.factor(paste(muni_size, rural)),
            pop = POBTOT,
         ...
         agegrp = cut(EDAD, 
                      breaks = c(17, 24, 44, 64, 150),
                      labels = c("18 to 24", "25 to 44", "45 to 64", "65+")),
         educ = case_when(NIVACAD == "00" | NIVACAD == "01" ~ 1, # less than primary
...
poststrat_9020 <- map(list(censo1990, censo2000, censo2010, censo2020), 
                      ~ .x %>%
                        ...
                        mutate(stratum = fct_drop(stratum),
                               state = if_else(state == "Ciudad de México",
                                               "Distrito Federal",
                                               state)) %>% 
...
poststrat_all <- poststrat_9020 %>% 
  select(-region) %>% 
  complete(year = 1990:2021, state, indig,
...
```{r pge_surveys_all, eval=FALSE}
surveys_controls_mex <- read_csv(file.path(mex20_dir,
                                           "..",
                                           "surveys_controls_mex.csv"),
                                 col_types = "cccccccccc") %>% 
  filter(!is.na(var_country)) %>% 
  select(-var_country, -var_year)

surveys_pge_mex <- read_csv(file.path(mex20_dir,
                                           "..",
                                           "surveys_pge_mex.csv"),
                                 col_types = "cccccccccc") %>% 
  filter(survey %in% surveys_controls_mex$survey)

surveys_data <- DCPOtools::surveys_data
vars_table <- surveys_pge_mex
controls_table <- surveys_controls_mex
...
for (i in seq(nrow(vars_table))) {
  cat(i, " ")
  v <- vars_table[i, ]
  cntrls <- controls_table %>% 
    filter(survey == v$survey) %>% 
    pivot_longer(var_state:var_indig) %>% 
    select(-survey)
  ...
  # Get controls
  t_data1 <- pmap(cntrls, function(name, value) {
    t_data %>% 
      transmute(!!name := eval(parse(text = value)))
  }) %>% 
    list_cbind()
  
  # Data for analysis
  vars1 <- t_data %>% 
    select(year = y_dcpo, target) %>% 
    mutate(survey = v$survey,
           item = v$item,
           thres = as.numeric(str_extract(v$item, "\\d+"))) %>% 
    bind_cols(t_data1) %>%
    left_join(amb_regions, by = join_by(var_state))
  
  all_sets_list[[i]] <- vars1
  rm(vars1)
}

all_sets <- list_rbind(all_sets_list) %>% 
  filter(complete.cases(.)) %>% 
  transmute(Intercept = 1,
            ...
            year,
            survey,
            var_agegrp = cut(var_age, 
                             breaks = c(17, 24, 44, 64, 150),
                             labels = c("18 to 24", "25 to 44", "45 to 64", "65+")),
            var_rural = factor(var_rural,
                               levels = c(FALSE, TRUE),
                               labels = c("urban", "rural")),
            var_female = factor(var_female,
                                levels = c(0, 1),
                                labels = c("male", "female")),
            var_indig = factor(var_indig,
                               levels = c(FALSE, TRUE),
                               labels = c("non-indig", "indig")),
            var_educ = if_else(var_educ == 0,
                               1,
                               var_educ) %>% 
              factor(levels = 1:5,
                     labels = c("Less than primary",
                                ...
                                "Complete high",
                                "University or more")),
            stratum = as.factor(paste(var_muni_size, var_rural))) %>% 
  arrange(year)

write_feather(all_sets, here::here("paper",
                                   "mexico",
                                   "data",
                                   "all_sets.arrow"))
...
```{r lmr, eval=FALSE}
all_sets <- read_feather(here::here("paper",
                                   "mexico",
                                   "data",
                                   "all_sets.arrow")) # %>% 
  # mutate(region_stratum = factor(paste(region, stratum)),
  #        state_stratum = factor(paste(state, stratum)),
  #        var_indig_female = paste("indig", var_indig, ", female", var_female))

m1 <- brm(target | thres(thres, gr = item) ~ Intercept +
            item + 
            (1|region) + (1|stratum) + (1|state) +
            (1|region:stratum) + (1|state:stratum) +
            (1|var_indig) + (1|var_indig:var_female) +
            (1|var_agegrp) + (1|var_female) + (1|var_educ) +
            s(year),
          data = all_sets,
          ...
          control = list(adapt_delta = 0.99, max_treedepth = 14),
          backend = "cmdstanr",
          file_refit = "on_change", # on_change
          file = "data/m1")

m01 <- brm(target | thres(thres, gr = item) ~ Intercept +
            item + 
            s(year) +
            s(year, state, bs="fs"),
          data = all_sets,
...
m02 <- brm(target | thres(thres, gr = item) ~ Intercept +
            item + 
            s(year),
          data = all_sets,
          family = cumulative("probit", threshold = "sum_to_zero"),
...
m11 <- brm(target | thres(thres, gr = item) ~ Intercept +
            item + 
             region +
             stratum +
             state +
...
m12 <- brm(target | thres(thres, gr = item) ~ Intercept +
            item + 
             region +
             stratum +
             state +
...
m13 <- brm(target | thres(thres, gr = item) ~ Intercept +
             item + 
             region +
             stratum +
             state +
...
```{r national_est, eval=FALSE}
# pick item with the most cases
item_ph <- all_sets %>%
  count(item) %>%
  filter(n == max(n)) %>%
  pull(item)

thres_ph <- as.numeric(str_extract(item_ph, "\\d+"))

state_levels <- levels(all_sets$state)

poststrat_df <- read_feather(file.path(mex20_dir,
                                        "..",
                                        "poststrat_all.arrow")) %>% 
  ungroup() %>% 
  mutate(year, # numeric
         region = as.numeric(region), # numeric
         stratum, # factor
         state = factor(state,
                        levels = levels(all_sets$state)),
         # var_indig = if_else(indig, 2, 1),
         var_indig = factor(indig + 1,
                            levels = c(1, 2),
                            labels = c("non-indig",
                                       "indig")),
            var_female = factor(female + 1,
                                levels = c(1, 2),
                                labels = c("male",
                                           "female")), # numeric
            var_agegrp = agegrp, # factor
            var_educ = factor(educ,
                              labels = c("Less than primary",
                                         "Complete primary",
                                         "Complete middle",
                                         "Complete high",
...
poststrat_df13 <- read_feather(file.path(mex20_dir,
                                         "..",
                                         "poststrat_all.arrow")) %>% 
  ungroup() %>% 
  transmute(year, # numeric
            region, # factor
            stratum, # factor
            state = factor(state),
            item = item_ph,
...
m1 <- readRDS("~/Documents/Projects/gender_equality/data/m1.rds")

lmr2 <- read_rds(here::here("paper/mexico/data/lmr/lmr2/lmr2.rds"))

epred_mat <- posterior_epred(lmr2, 
...
df_state_idealpoint <- tibble(state = rep(NA, length(levels(all_sets$state))),
                              year = ,
                       idealpoint_mean = NA,
                       idealpoint_sd = NA)

i = 1
for(s in levels(all_sets$state)){
...
all_sets <- all_sets %>% 
  mutate(GROUP = interaction(all_sets[group_vars], sep = " & "),
         TIME = factor(all_sets[[time_var]]))

shaped_data <- shape_data_modgirt(
  long_data = all_sets, #%>% 
    #filter(state %in% c("Distrito Federal", "Baja California",
    #                    "Michoacán", "Yucatán")),
  time_var = "TIME",
  unit_var = "GROUP",
  item_var = "item",
...
modgirt_out$fit$save_output_files(dir = here::here("paper",
                                                   "mexico",
                                                   "data",
                                                   "modgirt"),
                    random = FALSE)

modgirt_out$fit$diagnostic_summary()

# gather inputs
# model fit
use_draws <- posterior::as_draws_df(modgirt_out$fit$draws())

# modgirt_out
group_labels <- attr(modgirt_out$stan_data, "unit_labels")
item_labels <- attr(modgirt_out$stan_data, "item_labels")
time_labels <- attr(modgirt_out$stan_data, "time_labels")

# model information
Q <- modgirt_out$stan_data$Q

# pop proportions
pop_prop <- read_feather(here::here("paper",
                                  "mexico",
                                  "data-raw",
                                  "poststrat_all.arrow")) %>%
  mutate(var_agegrp = agegrp,
         # var_rural = factor(var_rural,
         #                    levels = c(FALSE, TRUE),
         #                    labels = c("urban", "rural")),
         var_female = factor(female,
                             levels = c(0, 1),
                             labels = c("male", "female"))) %>% 
            # var_indig = factor(var_indig,
            #                    levels = c(FALSE, TRUE),
            ...
            #                     "Complete high",
            #                     "University or more"))
  mutate(GROUP = interaction(.[group_vars], sep = " & "),
         TIME = factor(.[[time_var]])) %>% 
  group_by(TIME, state) %>% 
  mutate(n_state = sum(n)) %>% 
  group_by(TIME, GROUP) %>% 
  reframe(prop = sum(n)/n_state) %>% 
  ungroup() %>% 
  distinct()

# apply to each theta draw
theta_draws <- use_draws %>% 
  tidybayes::spread_draws(bar_theta[period, group, dimension]) %>% 
  ungroup() %>% 
  mutate(group = factor(group, labels = group_labels),
         time = factor(period, labels = time_labels))

# separate group columns
theta_draws2 <- theta_draws %>%
  tidyfast::dt_separate(col = group,
                        into = group_vars,
                        sep = " & ",
                        remove = FALSE) %>%
  as_tibble() 
...
theta_draws3 <- theta_draws2 %>% 
  left_join(pop_prop,
            by = c("time" = "TIME", "group" = "GROUP")) 

# region-period plot -------------------------------
period_plot_data <- theta_draws3 |> 
  summarise(
    .by = c(time, state, .draw),
    group_ave = weighted.mean(bar_theta, prop)
  ) %>%
  group_by(time, state) |> 
  summarise(across(
    group_ave,
...
state_files_dir <- here::here("paper",
                              "mexico",
                              "data-raw",
                              "from_des_to_subs_rep-main",
                              "01_data",
                              "ch_3",
                              "electoral_results",
                              "electas")
...
save(bd_leg_old_propietary, 
     file = here::here("paper",
                       "mexico",
                       "data-raw",
                       "bd_leg_old_propietary.rda"))
```

```{r bd_leg_all, eval=FALSE}
bd_leg_old_propietary <- rio::import(here::here("paper", 
                                                "mexico",
                                                "data-raw",
                                                "bd_leg_old_propietary.rda"),
                                     trust = TRUE)
