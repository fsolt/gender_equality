...
As we have been looking at _average_ responses, if this is true, we may be overlooking additional signs of backlash against gender equality that are limited to particular Korean demographic groups and counterbalanced by others.
...
@fig-kd1mplot1 breaks down the responses to the four survey items on gender equality in politics by gender, age, and education, with darker lines representing women, younger generations, and those with university educations, respectively.^[
