...
These cases indicate that the public lashes back against gender equality not when women chief executives succeed but instead when they fail.
...
It also exposed the extent of regulatory capture that had persisted since the state corporatism of Park Chung-hee [@You2017].
...
The protests that followed evidenced---and perhaps even deepened---the public's anger. 
