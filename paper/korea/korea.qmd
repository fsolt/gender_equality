...
```{r eap_korea, fig.cap="Korean Presidential Approval During the Park Administration", fig.height=4}
#| label: fig-park_eap 
...
Park's presidential approval is shown in 
