...
Because the PGE scores are measured at the annual level, Kim Campbell's four-month term as Canada's prime minister in 1993 and Anneli Jäätteenmäki's two months as Finland's prime minister in 2003 are too short to observe changes in this variable.
...
Taken as a whole, then, the evidence from the PGE scores does not support the hypothesis of public opinion backlash triggered by women's successes at the highest levels of politics. 
...
```{r, fig.cap="Macroegalitarianism and Executive Approval by Term for Woman Chief Executives", cache=FALSE, dev='cairo_pdf'}
#| label: fig-pge_eap
