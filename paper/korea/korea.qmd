...
Korea's recent political history seems to provide a strong basis for these fears that public opinion lashes back against women's successes in winning office and other moves toward gender equality.
...
If this is true, by looking at _average_ responses as we have, we may be overlooking additional signs of backlash against gender equality that are limited to particular Korean demographic groups and, in the entire public's opinion, counterbalanced by other groups.
...
@fig-kd1mplot1 breaks down the responses to the four survey items on gender equality in politics by gender, generation, and education, with darker lines representing women, younger generations, and those with university educations, respectively.^[
...
There is little sign of polarization.
...
Moreover, these patterns, if evidently fairly short-lived, were broadly shared across men and women, young and old, and more and less educated.
...
Taken as a whole, then, the evidence from the PGE scores does not support the hypothesis that the mere election of a woman to a country's highest office works to trigger a backlash against gender equality in the public sphere across the entire public.
