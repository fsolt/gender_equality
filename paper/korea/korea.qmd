...
These patterns suggest some support for the view that when a woman holds a country's chief executive office, her high visibility in what is traditionally among most masculine domains may trigger a distinctive response in macroegalitarianism.
...
These cases indicate that the public lashes back against gender equality not when women chief executives succeed but rather when they fail.
...
Park's net presidential approval is shown in @fig-park_eap.
...
With nearly half of the public opposed to the project from the start and the remainder unlikely to be satisfied with the inevitably shabby results, for her entire time in office May's approval ratings were predictably under water  [see, e.g., @Byrne2021].^[
In the end May's successor, Boris Johnson, was only able to 'get Brexit done'  "by agreeing that Northern Ireland would continue to follow the EU’s rules and regulations on goods trade" and being "economical with the truth" [@Brusenbauch-Meislova2024, 275, 281]: in other words, by accepting that the Brexit cheese submarine would never really be seaworthy and lying about it.]
