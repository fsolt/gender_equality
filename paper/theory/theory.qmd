...
Still, there is also strong theoretical grounds to expect that democratic representation may _not_ occur: politics is multidimensional.
...
Macroegalitarianism in particular may not be represented in terms of either more women in office or the adoption of policies that advance gender equality for this reason.
...
There is a substantial body of empirical research that finds that the public does in fact get what it wants, supporting the theory of representation.
...
The severe limitations in the available public opinion data that we described in the previous chapter have sharply restricted researchers' ability to test these theories directly with regard to gender equality [@Paxton2021, 127].
...
This seems unlikely.
@Schwindt-Bayer2005, one work that does include a measure of public opinion along with women's officeholding, finds using a structural equation model of a cross-section of 31 democracies that opinion influences the adoption of equality-enhancing policies only through its relationship to more women holding office---that is, through selection only.

In short, there are convincing arguments both for and against expecting democratic representation of the public's attitudes toward gender equality, and the evidence presented in the literature is mixed in its findings.
...
Consider the evidence on the political question of how voters respond to election results.
...
@Bafumi2010 looks over the course of the midterm year at the trend in party-vote preferences (the so-called 'generic ballot' that includes no names of candidates) in 16 midterm elections and concludes that a substantial portion of the electorate gradually decides to vote to reverse the trend in policy set off by their own choices in the previous election.
The success of radical right parties in winning parliamentary seats for the first time, @Bischof2019 finds, pushes left-leaning voters to identify as even farther to the left.
...
Providing additional suggestive evidence, @Kerevel2017 found that, in Mexico after the passage of gender quotas, women living in districts in which female candidates ran expressed lower political engagement, ostensibly because the imposition of quotas to advance gender equality reduces the public's gender egalitarian views [see also, e.g., @Clayton2015].^[
Note that @Kerevel2017 [, 459-460] acknowledges that this result could also be due to sexist party elites starving women candidates of the resources needed to spur citizen engagement; unfortunately, the work is unable to distinguish between these possiblities.]
