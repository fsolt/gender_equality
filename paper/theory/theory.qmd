...
With reference to gender equality in the public sphere, dynamic democracy looks as follows.
...
In the remainder of this chapter, we discuss in more detail the theoretical arguments on why and how democratic representation and public responsiveness may or may not occur, both in general and specifically with regard to gender equality.
We provide a brief review of existing empirical research on each as well.
...
With regard to gender egalitarianism, the argument for why we should see democratic representation is straightforward: when the public holds a more gender-egalitarian view of women's roles in the public sphere, these views create electoral incentives for parties to respond by running more women, more women will win election, and policies advancing gender equality will be more likely to pass.
...
Still, there are also strong theoretical grounds to expect that democratic representation may _not_ always occur: politics is multidimensional.
...
For this reason, macroegalitarianism in particular may not be represented in terms of either more women in office or the adoption of policies that advance gender equality.
The multidimensionality of politics raises the possibility that even parties ostensibly favoring gender equality may nevertheless put measures promoting it behind other issues; the greater relative power of men to set the agenda within party organizations only makes this possibility more likely [see, e.g., @Htun2012, 553; @Weeks2022, 69].
Moreover, given parties' crucial role as gatekeepers between women and political power [see, e.g., @Caul1999], the (male) party elites who decide who may run appear to underestimate the public's willingness---or even preference---to vote for women [see, e.g., @Norris1995; @Kunovich2005; @Luhiste2015].^[
...
@Kim2022b argues similarly and in a study of Korean attitudes notes considerable differences between patterns of rejection of traditional gender norms and of support for policies advancing gender equality [see also @Lee2025, 790].
...
The theoretical arguments against expecting democratic representation appear to us to be at least as strong as those in its favor.

Turning from theory to evidence, there is a substantial body of empirical research that finds that the public does in fact get what it wants, supporting the theory of democratic representation.
...
Albeit with much less scholarly consensus, there are prominent studies that conclude that democratic representation of the public's policy preferences is also strong.
...
On the other hand, there are many studies indicating that policy representation does not always occur.
@Page1983, for one, finds that when U.S. policy changed over four decades, it was twice as likely to move in the same direction as shifting opinion as counter to it, with conservative changes and low-salience policy reforms particularly likely to be contrary to developments in public opinion.
...
As we showed in the previous chapter, the severe limitations in the available public opinion data on gender egalitarianism have sharply restricted researchers' ability to test these theories directly with regard to gender equality [@Paxton2021, 127].
What works do exist indicate democratic representation occurs, at least with regard to women in office.
...
@Alexander2012 adds some over-time perspective by looking at 25 countries in two time periods separated by a decade; where gender egalitarianism regarding political leaders increased, so did the share of women in the legislature.
Combined with the 'file drawer problem,' in which null results are unlikely to be written up or published [@Franco2014], however, the relative paucity of studies renders this literature decidedly inconclusive.

In short, there are convincing arguments both for and against expecting democratic representation of the public's attitudes toward gender equality, and the evidence presented in the literature is at best thin.
Our contention, as we mentioned in the introductory chapter, is that the reason for the unresolved state of the current scholarship is the limits of the evidentiary base that existing studies have examined.
Cross-sectional studies dominate this literature, making drawing causal conclusions unwarranted, a point sometimes acknowledged even by the works themselves [e.g., @Norris2001, 134-135], and the works that do examine change over time are mostly limited to the United States.
To see if and to what extent the composition of legislatures and the content of policy represent the macroegalitarianism of the public, we are going to have to look with more and better data.


### Selection or Adaptation?

A related open question to _if_ democratic representation occurs is _how_ it happens if it does.
Is electoral turnover necessary for policy adoption or do legislators of all stripes respond to the shifting opinion of the public?
...
That is, the relationship between women's officeholding and policies advancing gender equality may be driven by both being products of public opinion.
...
On the other hand, @Schwindt-Bayer2005, one work that does include a measure of public opinion along with women's officeholding, finds using a structural equation model of a cross-section of 31 democracies that opinion influences the adoption of equality-enhancing policies only through its relationship to more women holding office---that is, through selection only.
Here, too, we stand in need of new and better evidence.
...
The key point of debate is whether public opinion moves against a newly elected political actor or a newly adopted policy or instead moves further in its support.
Arguments that public opinion reacts negatively to political victors or policy changes are common.
...
And as mentioned in the introduction, the thermostatic model provides a generalized theory of public opinion backlash.
...
Through these processes, policies make their own constituencies among the public and create demand for more of the same.
...
Given that the theories just described yield conflicting expectations, we turn to the evidence for each.
There is substantial empirical support for self-undermining feedback.
Consider the works on the political question of how voters respond to election results.
That the party of the sitting U.S. president nearly always loses seats in the midterm legislative elections is a stylized fact of American politics.
@Bafumi2010 looks at the movement over the course of the midterm year in party-vote preferences (the so-called 'generic ballot' that includes no names of candidates) in 16 midterm elections and concludes that a substantial portion of the electorate gradually decides to vote to reverse the trend in policy set off by their own choices in the previous election.
The success of radical right parties in winning parliamentary seats for the first time, @Bischof2019 finds, pushes left-leaning voters to identify themselves as even farther to the left.
@Bustikova2014 concludes that in central and eastern Europe, the success of parties representing ethnic minorities in joining governing coalitions and so influencing policy triggers increased support for radical right parties that oppose policies of ethnic accommodation.
In a study of Germany's subnational Länder governments, @Arend2025 finds that Green Party success at this level drives increased enmity for the Greens and more support for the country's conservative Christian Democratic parties.
While the argument for public opinion backlash against women in office has drawn calls for more research [see @Sanbonmatsu2008], empirical studies on how women in office influence gender egalitarian public opinion is scant [see @OBrien2019, 59], likely again due to data issues.
One exception, @Woo2025a, finds that support for gender equality in politics among the Korean public declined during the presidency of Park Geun-hye, the first woman elected to be Korea's chief executive.
We follow up on this finding in Chapter 6.
Providing additional suggestive evidence, @Kerevel2017 finds that, in Mexico after the passage of gender quotas, women living in districts in which female candidates ran expressed lower political engagement, ostensibly because the imposition of quotas to advance gender equality reduces the public's gender egalitarian views [see also @Clayton2015].^[
Note that @Kerevel2017 [, 459-460] acknowledges that this result could also be due to sexist party elites starving women candidates of the resources needed to spur citizen engagement; unfortunately, the work is unable to distinguish between these possibilities.]

With regard to policy, @Soroka2010 finds that as spending on defense and on social expenditure went up, public opinion favoring spending in each of these sectors subsequently went down---and as spending went down, demand for spending then went up---in the United States, Canada, and the United Kingdom.
...
There is also some suggestive evidence on self-reinforcing effects of women's officeholding from research looking to women's political behavior; for an overview, see @Paxton2021 [, 131-133].]
@Campbell2003 [, 95] documents that "the growth of Social Security over time has met with little backlash from taxpaying nonrecipients" and finds instead that the U.S. public has since its inception consistently favored the program's expansion.
...
There is some evidence for accelerating feedback with regard to gender equality as well.
...
@Alexander2012, again working with 25 countries at two points in time, finds that growing women's officeholding yielded increases in belief that men are not better political leaders than women _among women_ but did not change attitudes among men.
Conversely, @Kerevel2015 finds in a cross-section of Mexican municipalities that the presence of a woman mayor increased disagreement that men make better political leaders _among men_ but did not change attitudes among women.^[
Similarly, where the chief councilor position in villages in West Bengal, India, were randomly reserved for women candidates, a vignette experiment revealed that among men identical fictional male and female politicians were judged to be similarly effective whereas men in villages that had not experienced female leadership judged the hypothetical male leader as significantly more effective; women in both settings expressed little bias [@Beaman2009, 1500].]
...
Looking across 87 countries in as many as four years over two decades, @Kim2023 find that the presence of robust gender quotas---but not weaker ones---are associated with more gender egalitarian attitudes toward politics.
...
Across 20 Latin American countries, @Smith2017 reports that political gender stereotypes are less common where gender quotas are in place.
...
If the foregoing discussions seem contradictory, it is because they are: @Busemeyer2021 [, 138] notes that the works finding evidence of self-undermining feedback and those that point to accelerating feedback "so far have largely ignored each other."
...
@Morgan2013 presents further evidence against any feedback of politics on the gender egalitarianism: in a cross-section of 19 Latin American countries, that study finds that the share of women in the legislature did _not_ predict support for gender equality in politics in the public.

Still, the cross-sectional research designs dominant in the works just reviewed leave doubt regarding the direction of causation.
...
As with democratic representation, to get answers to whether and how macroegalitarianism in the public responds to political and policy developments, we will have to look at more and better data.
...
The Public Gender Egalitarianism scores we present in the next chapter are motivated by a desire to get beyond research designs that are limited to "just the United States" or "just western Europe"---designs that are all too common, as we found at @sec-scholarship---that is, by a desire to enable cross-national, cross-regional work [see @Wilson2022].
But, on the other hand, we always need to avoid including cases to which the theory simply does not apply.
The public opinion theories outlined above presuppose a certain minimum level of _democracy_---at least the minimal definition of democracy presented by @Przeworski2000 [, 14-16] as "a regime in which those who govern are selected through contested elections."
...
Our point is that the mechanisms through which public opinion may be translated to policy in authoritarian regimes is different from those suggested in the theories outlined above, and so for present purposes we should set those cases aside.]
...
But the theories outlined in this chapter clearly apply to the shaded countries, so it is these countries that will be the subject of this book.

```{r, fig.cap="The Cases Examined in This Book: The OECD", fig.width = 7.5}
#| label: fig-oecdmap
