...
This is fortunate from the researcher's perspective, because a high association between, say, public opinion on an issue and the policy in effect with regard to that same issue at any single point in time may be evidence of either democratic representation or public responsiveness or both.
...
If the previous two paragraphs seems contradictory, @Busemeyer2021 [, 138] notes that the works finding evidence of self-undermining feedback and those that point to accelerating feedback "so far have largely ignored each other."
...
That work also identifies six other important issues that were not politicized over the period examined and finds they did not respond in a self-undermining fashion either.
Intriguingly for present purposes, @Atkinson2021 also argues that gender egalitarian public opinion should not exhibit responsiveness.
...
@Kim2023 examines four waves of the WVS in 87 countries for a total of 187 observed country-years; in multilevel models of individuals with varying intercepts for country-years and countries, it finds strong evidence that women's officeholding influences attitudes toward women in politics.
...
Worse, there is evidence that the public opinion supporting gender equality in politics responds _negatively_ if women in office are revealed to have engaged in corruption, the frequent corruption of male politicians notwithstanding [@Woo2025a].
...
Still, the cross-sectional research designs these works employ leave doubt regarding the direction of causation.
Indeed, the assumption that gender egalitarian public opinion is simply causally prior to women in office or policies advancing gender equality---the assumption that policy responsiveness is nonexistent---is common in the representation literature discussed in the previous section [see, e.g., @Schwindt-Bayer2005, 416].
