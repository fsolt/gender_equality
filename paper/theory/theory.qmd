...
In the remainder of this chapter, we discuss in more detail the theoretical arguments on why democratic representation and public responsiveness may or may not occur, both in general and specifically with regard to gender equality.
...
Turning from theory to evidence, there is a substantial body of empirical research that finds that the public does in fact get what it wants, supporting the theory of representation.
...
In a study of Germany's Länder, @Arend2025 finds that Green Party success at the subnational level drives increased enmity for the Greens and more support for the country's conservative Christian Democratic parties.
...
@Morgan2013 presents further evidence against any feedback of politics on the gender egalitarianism: in a cross-section of 19 Latin American countries, that study finds that the share of women in the legislature the public did _not_ predict support for gender equality in politics.
