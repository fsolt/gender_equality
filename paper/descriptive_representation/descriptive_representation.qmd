...
```{r wrts, fig.cap="Women's Officeholding in the OECD", fig.height = 9, fig.width = 7.5}
#| label: fig-wrts
...
```{r m1plot, fig.cap="Predicting Women's Officeholding in OECD Democratic Elections", fig.height = 7, fig.width = 7.5}
#| label: fig-m1-dr
...
```{r m3plot, fig.cap="Predicting Women's Parliamentary Representation in OECD Democratic Elections", fig.height = 9, fig.width = 7.5}
#| label: fig-m3-wr
