...
coef_plot_m1 + lag_plot_m1 +
  ...
  plot_annotation(caption = "Notes: Dots indicate posterior means; whiskers describe 80%\ncredible intervals; shading depicts the posterior probability density function.")
```
...
```{r pfemplot, fig.cap="Public Gender Egalitarianism and Women’s Share of Party Legislative Seats in OECD Democracies \\label{pfemplot}", fig.height = 6, fig.width = 7.5}
