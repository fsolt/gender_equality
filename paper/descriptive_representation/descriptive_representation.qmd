...
Among the advanced democracies, FMI scores range from one to three.
...
How the FMI has changed over time across the OECD countries during the elections we consider here is shown in Figure&nbsp;\ref{fmiplot}.
