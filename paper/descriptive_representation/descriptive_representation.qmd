...
```{r wr_b}
if (!file.exists(file.path(descrep_path, "wr_b_results.rda"))) {
  ...
  save(m2_data_2sd, coef_data0, cy_summary, file = file.path(descrep_path,
                                                          "wr_results.rda"))
} else {
  load(file = file.path(descrep_path, "wr_results.rda"))
}
```
...
#               sd2 = value)
#   
# coef_data0_m3 <- m3_wr_b1 %>% 
#   tidybayes::gather_draws(`bs?p?_.*`, regex = TRUE) %>% 
#   filter(!`.variable`=="b_Intercept") %>% 
#     left_join(m3_data_2sd, by = join_by(.variable))
#   
# save(m3_data_2sd, coef_data0_m3, file = file.path(descrep_path,
#                                                   "m3_results.rda"))
# } else {
#   load(file = file.path(descrep_path, "m3_results.rda"))
# }
```

```{m3_interaction_plot}
# interplot_b(m3_wr_b, "national_quota_diff", "pge_diff")
