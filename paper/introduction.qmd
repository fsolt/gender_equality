...
<!-- Combining recognition that gender equality is democracy (e.g., Krook2022 in APSA-CP) with debates on how public opinion affects democracy (Claassen and DCPO) yields the understanding that public gender egalitarianism is democratic support (see, maybe, Welzel2013) -->
