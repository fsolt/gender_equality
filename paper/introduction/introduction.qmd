...
The observation of four decades ago of @Stimson1985 [, 914] regarding political science that "[w]e do comparative analyses across space, dynamic analyses over time, but almost never do we do dynamic comparison" holds true among these prominent and interdisciplinary works on attitudes toward gender equality.
...
Drawing on recent advances in latent variable modeling of public opinion and a comprehensive collection of survey data, we update the Public Gender Egalitarianism (PGE) dataset [@Woo2023] to address the need for comparable estimates of macroegalitarianism across countries and over time.
...
In terms of @fig-proj-kt, the updated PGE dataset lands beyond the right hand border and toward the top, with more countries than any of the surveys and a greater mean number of years per country than all but two single-country surveys: Sweden's SOM and the U.S. GSS.
...
These new data on macroegalitarianism, based on thousands of surveys conducted in countries around the world, allows us to examine the causes and consequences of macroegalitarianism together in comparative and dynamic perspective.
...
It has long been known that cross-sectional associations, that is, those established by looking only across countries at a single time, have several weaknesses that are not ameliorated no matter how broadly comparative the sample.
...
Pooling data across countries and over time in analyses that are both comparative _and_ dynamic has been long recognized as "an extraordinarily robust research design" for drawing causal inferences [@Stimson1985, 916] and given the inability to experimentally manipulate any of our variables of interest---public opinion, women in office, or policy---provides the best possible evidence of causation.
