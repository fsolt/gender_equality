...
If Korean public opinion was represented in the election results, that raises the question of why the Korean public is so anti-egalitarian.
Some observers see events like these as signs of a recurring backlash in the public against gender equality.
...
<!-- Used in theory: For example, @Campbell2003 [, 95] documents that "the growth of Social Security over time has met with little backlash from taxpaying nonrecipients" and finds that, in fact, the U.S. public has consistently favored the continued expansion of the program. -->
...
This work has several advantages over the existing scholarship on public opinion toward gender roles in the public sphere.
