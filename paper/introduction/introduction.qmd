...
Vignettes of the 2022 Korean and 2024 Mexican presidential elections.
...
Some observers see in events like the Korean election as signs of a recurring backlash in the public against gender equality.
...
## A Scholarship Limited by the Existing Data {#sec-scholarship}
...
The observation of four decades ago of @Stimson1985 [, 914] that "[w]e do comparative analyses across space, dynamic analyses over time, but almost never do we do dynamic comparison," made with regard to political science, also holds true among these prominent and interdisciplinary works on attitudes toward gender equality.
...
Addressing the absence of cross-national time-series data on attitudes toward gender equality is the first of the contributions of this book.
...
If we see that countries where the public holds more gender egalitarian views consistently also have adopted policies that advance gender equality, we still do not know whether policy adoptions represent the public opinion, or public opinion responds to policy change, or both, or neither---policy and public opinion may both result some other, unobserved cause [see, e.g., @Rustow1968, 48].
...
We bolster confidence in our conclusions in two additional ways.
...
Therefore, we pay careful attention to the measurement validation of the PGE data as our operationalization of the concept of macroegalitarianism, public opinion toward gender roles in politics and the workplace.
And with regard to advancements toward gender equality---which constitute the outcome when assessing the extent of democratic representation and the treatment from the standpoint of theories of public responsiveness---we employ multiple indicators.
