...
And with regard to what constitute the outcome when assessing the extent of democratic representation and the treatment from the standpoint of theories of public responsiveness, we employ multiple indicators.
We examine women's descriptive representation in national legislatures, a measure of gender equality in politics; the policy most closely linked to advancing gender equality in politics, the adoption and reform of gender quotas; and the World Bank’s Women, Business, and Law v1.0 policy index [@WorldBank2024], a count of thirty-five policies that advance gender equality in the workplace.


Multilevel @Lieberman2005 @Findley2021 @Snyder2001
