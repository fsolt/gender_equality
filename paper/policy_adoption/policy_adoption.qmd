...
But also, as a practical matter, the PGE data as yet extends to 2022 in only two of the thirty-eight countries in our sample.
This makes even a cross-sectional analysis infeasible.
We must look elsewhere for data on childcare policy.

Availability is more important than spending, and the available spending data has validity problems anyway because the it covers older preschool children, whose care is associated more with part-time, dead-end work.
To measure childcare availability across our countries of interest, we look to OECD data on enrollments in early childhood education and care among the very young, children aged zero to two. 
