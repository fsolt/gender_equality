...
## Advancing Political Equality: Legislative Candidate Gender Quotas {.unnumbered}
...
## Advancing Equality in Workplace: Work-Family Policies {.unnumbered}

## Advancing Equality in Care: Family Leave {.unnumbered}
...
if (!file.exists(file.path(policy_path, "data-raw", "leave.rda"))) {
  ...
  leave <- wbl %>% 
    transmute(country = countrycode(economy, "country.name", "country.name"),
              year = report_year - 1,
              equality_leave = 
              )
...
```{r enrplot, fig.cap="Enrollment in Early Childhood Education and Care in the OECD", fig.height = 9, fig.width = 7.5}
#| label: fig-enrplot
...
```{r ececenrplot, fig.cap="Public Gender Egalitarianism and Enrollment in Early Childhood Education and Care in OECD Countries", fig.height = 9, fig.width = 7.5}
