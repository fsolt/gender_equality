...
@m1_nq_plot presents the results.
...
@fig-m2-nq-plot presents the results.
...
In other words, the conclusions drawn from @fig-m1-nq-plot are not generated by simultaneity bias.


, and the right panel shows those for macroegalitarianism.
