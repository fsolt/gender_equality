...
One of the most-studied policies relating to gender equality is the adoption of gender quotas for candidates running for legislative seats.
...
```{r nqplot, fig.cap="National Quotas in the OECD \\label{nq_plot}", fig.height = 7, fig.width = 7.5}
